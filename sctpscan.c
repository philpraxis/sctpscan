...
/****************************************************************************
 * COPYING -- Describes the terms under which SCTPscan is distributed. A    *
 * copy of the GNU GPL is appended to this file.                            *
 *                                                                          *
 ********************IMPORTANT SCTPSCAN LICENSE TERMS************************
 *                                                                          *
 * The SCTPscan is (C) 2001-2007 Philippe Langlois. This program is free    *
 * software; you may redistribute and/or modify it under the terms of the   *
 * GNU General Public License as published by the Free Software             *
 * Foundation; Version 2 with the clarifications and exceptions described   *
 * below.  This guarantees your right to use, modify, and redistribute      *
 * this software under certain conditions. If you wish to embed SCTPscan    *
 * technology into proprietary software, we sell alternative licenses       *
 * (contact pl@tstf.net).  Dozens of software vendors already               *
 * license SCTPscan technology such as host SCTP discovery, port scanning,  *
 * fuzzing, and stack version detection.                                    *
 *                                                                          *
 ...
 * following:                                                               *
 * o Integrates source code from SCTPscan                                   *
 * o Reads or includes SCTPscan copyrighted data & files, such as           *
 *   SCTPscan-os-fingerprints or SCTPscan-service-probes.                   *
 * o Executes SCTPscan, parses the results (as opposed to typical shell or  *
 *   applications, which simply display raw SCTPscan output and so are      *
 *   not derivative works.)                                                 *
 * o Integrates/includes/aggregates SCTPscan into a proprietary executable  *
 *   installer, such as those produced by InstallShield.                    *
 * o Links to a library or executes a program that does any of the above    *
 *                                                                          *
 * The term "SCTPscan" should be taken to also include any portions or      *
 * derived works of SCTPscan. This list is not exclusive, but is just meant *
 * to clarify our interpretation of derived works with some common examples.*
 * These restrictions only apply when you actually redistribute SCTPscan.   *
 * For example, nothing stops you from writing and selling a proprietary    *
 * front-end to SCTPscan.  Just distribute it by itself, and point people   *
 * to http://sctp.tstf.net/ to download SCTPscan.                           *
 *                                                                          *
 * We don't consider these to be added restrictions on top of the GPL, but  *
 * just a clarification of how we interpret "derived works" as it applies   *
 * to our GPL-licensed SCTPscan product.  This is similar to the way Linus  *
 * Torvalds has announced his interpretation of how "derived works"         *
 * applies to Linux kernel modules.  Our interpretation refers only to      *
 * SCTPscan - we don't speak for any other GPL products.                    *
 *                                                                          *
 * If you have any questions about the GPL licensing restrictions on using  *
 * SCTPscan in non-GPL works, we would be happy to help. As mentioned above *
 * we also offer alternative license to integrate SCTPscan into proprietary *
 * applications and appliances.  These contracts have been sold to dozens   *
 * of software vendors, and generally include a perpetual license as well   *
 * as providing for priority support and updates as well as helping to      *
 * fund the continued development of SCTPscan technology.  Please email     *
 * pl@tstf.net for further information.                                     *
 *                                                                          *
 * If you received these files with a written license agreement (except GPL)*
 * or contract stating terms other than the terms above, then that          *
 * alternative license agreement takes precedence over these comments.      *
 * Otherwise, this license agreement replaces any other license you may     *
 ...
 *                                                                          *
 * Source code also allows you to port SCTPscan to new platforms, fix bugs, *
 * and add new features.  You are highly encouraged to send your changes    *
 * to pl@tstf.net for possible incorporation into the main                  *
 * distribution.  By sending these changes to Philippe Langlois or one the  *
 * SCTPscan mailing lists, it is assumed that you are offering Philippe     *
 * Langlois and TSTF the unlimited, non-exclusive right                     *
 * to reuse, modify, and relicense the code.  SCTPscan will always be       *
